...
| Release owner | [Release Verification](release-verification.md), [Docker Usage](docker.md) | Produce repeatable release evidence. |
...
5. Export manifest and policy evidence for releases.
6. Enable MCP runtime routing when static checks are stable.

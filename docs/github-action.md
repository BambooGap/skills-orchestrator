...
For protected production repositories, use [Production Adoption](production-adoption.md). The
examples below are intentionally easy to copy for adoptions; production gates should pin the action to
...
`BambooGap/skills-orchestrator@v4.8.44`, even before the Marketplace listing is public.

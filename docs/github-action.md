...
examples below are intentionally easy to copy for pilots; production gates should pin the action to
...
`BambooGap/skills-orchestrator@v4.8.19`, even before the Marketplace listing is public.

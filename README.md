...
[![GitHub Action](https://img.shields.io/badge/GitHub%20Action-v4.8.43-blue?logo=githubactions&logoColor=white)](docs/github-action.md)
...
|---------|----------------|-------------|
| OSS CLI | `v4.8.43` on PyPI | `python3.12 -m pip install skills-orchestrator` |
| GitHub Action | `v4.8.43` release tag | `BambooGap/skills-orchestrator@v4.8.43` |
| Container image | Published on GHCR | `ghcr.io/bamboogap/skills-orchestrator:v4.8.43` |

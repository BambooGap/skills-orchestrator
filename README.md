...
[![GitHub Action](https://img.shields.io/badge/GitHub%20Action-v3.0.4-blue?logo=githubactions&logoColor=white)](docs/github-action.md)
...
|---------|----------------|-------------|
| OSS CLI | `v3.0.4` on PyPI | `python3.12 -m pip install skills-orchestrator` |
| GitHub Action | `v3.0.4` release tag | `BambooGap/skills-orchestrator@v3.0.4` |
| Container image | Published on GHCR | `ghcr.io/bamboogap/skills-orchestrator:v3.0.4` |
...
```bash
docker run --rm ghcr.io/bamboogap/skills-orchestrator:v3.0.4 --version
```

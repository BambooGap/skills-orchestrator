...
[![GitHub Action](https://img.shields.io/badge/GitHub%20Action-v3.0.5-blue?logo=githubactions&logoColor=white)](docs/github-action.md)
...
|---------|----------------|-------------|
| OSS CLI | `v3.0.5` on PyPI | `python3.12 -m pip install skills-orchestrator` |
| GitHub Action | `v3.0.5` release tag | `BambooGap/skills-orchestrator@v3.0.5` |
| Container image | Published on GHCR | `ghcr.io/bamboogap/skills-orchestrator:v3.0.5` |
...
```bash
docker run --rm ghcr.io/bamboogap/skills-orchestrator:v3.0.5 --version
```

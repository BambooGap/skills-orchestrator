...
[![GitHub Action](https://img.shields.io/badge/GitHub%20Action-v4.7.9-blue?logo=githubactions&logoColor=white)](docs/github-action.md)
...
|---------|----------------|-------------|
| OSS CLI | `v4.7.9` on PyPI | `python3.12 -m pip install skills-orchestrator` |
| GitHub Action | `v4.7.9` release tag | `BambooGap/skills-orchestrator@v4.7.9` |
| Container image | Published on GHCR | `ghcr.io/bamboogap/skills-orchestrator:v4.7.9` |
...
```bash
docker run --rm ghcr.io/bamboogap/skills-orchestrator:v4.7.9 --version
```

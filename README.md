...
[![GitHub Action](https://img.shields.io/badge/GitHub%20Action-v4.8.17-blue?logo=githubactions&logoColor=white)](docs/github-action.md)
...
|---------|----------------|-------------|
| OSS CLI | `v4.8.17` on PyPI | `python3.12 -m pip install skills-orchestrator` |
| GitHub Action | `v4.8.17` release tag | `BambooGap/skills-orchestrator@v4.8.17` |
| Container image | Published on GHCR | `ghcr.io/bamboogap/skills-orchestrator:v4.8.17` |
...
jobs:
  skills:
    ...
    steps:
      ...
      - uses: BambooGap/skills-orchestrator@v4.8.17
        with:
          config: config/skills.yaml
          policy-pack: builtin/team-standard
          upload-sarif: true
